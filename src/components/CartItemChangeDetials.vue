		...
		<v-card>
			...
			<v-card-subtitle>
				<v-row no-gutters>
					<v-col
						cols="2"
						v-for="price in Object.keys(item.price)"
						:key="price"
					>
						<v-chip
							:class="
								currentPrice === price ? 'active chip' : 'chip'
							"
			...
			<v-card-text>
				<v-row no-gutters>
					<v-col cols="2" v-for="extra in item.extra" :key="extra">
						<v-chip
							:class="
								extraIsActive(extra) ? 'active chip' : 'chip'
							"
				...
				<v-row no-gutters>
					<v-col
						cols="2"
						v-for="remark in item.remarks"
						:key="remark"
					>
						<v-chip
							:class="
								remarkIsActive(remark) ? 'active chip' : 'chip'
							"
